...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                'title' => 'VS Furniture API Documentation',
                'description' => 'API documentation for VS Furniture Laravel Backend',
                'version' => '1.0.0',
                'contact' => [
                    'name' => 'VS Furniture',
    ...
    'defaults' => [
        ...
        'scanOptions' => [
            ...
            /**
             * openapi: defaults to \OpenApi\Generator::DEFAULT_VERSION .
             *
             * @see \OpenApi\scan
             */
            'openapi' => null,
            ...
            /**
             * validate: defaults to \OpenApi\Generator::DEFAULT_VERSION .
             *
             * @see \OpenApi\scan
             */
            'validate' => null,
        ...
        'ui' => [
            'display' => [
                ...
                /**
                 * It's UI :). If you want the documentation as a single page, set this to true
